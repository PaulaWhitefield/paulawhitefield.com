...
<p style="text-align: center;"><img src="<?php echo $images_url; ?>/gifs/welcome-to-my-homepage-roses.gif" alt="Welcome to my homepage image with roses"></p>
...
<p style="text-align: center;"><img src="<?php echo $images_url; ?>/gifs/welcome-to-my-homepage-purple-flowers.gif" alt="Welcome to my homepage image with purple flowers"></p>
